...
// 导入所有组件
// 注意：假设每个组件都已经通过前面的代码创建好了
import PerfectVoidIntro from './PerfectVoid';
import PerfectVoidScenes from './PerfectVoidScenes';
import PerfectVoidExploration from './PerfectVoidExploration';
import PerfectVoidRevelation from './PerfectVoidRevelation';
import PerfectVoidFinale from './PerfectVoidFinale';
...
const PerfectVoidMainWrapper = () => {
  ...
  // 故事部分
  const storyParts = [
    { id: 'intro', component: PerfectVoidIntro, title: '引言' },
      ...
      >
        ...
        <div className="menu-footer">
          <button className="reset-button" onClick={() => {
            if (window.confirm('确定要重置进度吗？这将删除您的阅读记录。')) {
